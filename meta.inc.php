    	...
    	if($bp_seo_components != '' ){
      		foreach ($bp_seo_components as $bp_seo_component => $value ){
        		if ($current_action == $value[slug]) {
	          		$meta = replace_special_tags(get_blog_option(SITE_ID_CURRENT_SITE,"bp_seo_".$bp_seo_component."_".$current_component."_extends"));
	          		return bp_seo_meta_length('bp_seo_metatitle_length',$meta[0],150);
        		}
      		}
    	}
  	...
  	if($bp_seo_components != '' ){
    	...
    	foreach ($bp_seo_components as $bp_seo_component => $value ){
      		if ($directory &&  $current_component == $value[slug]) {
        		$meta = replace_special_tags(get_blog_option(SITE_ID_CURRENT_SITE,"bp_seo_".$current_component."_directory"));
        		return bp_seo_meta_length('bp_seo_metatitle_length',$meta[0],150);
      		}
      		if (!$directory &&  $current_component == $value[slug]){
        		if ($bp_seo_component == $current_component && bp_is_single_item()) {
          		$meta = replace_special_tags(get_blog_option(SITE_ID_CURRENT_SITE,"bp_seo_".$current_component.'_'.$current_component.'_extends'));
          		return bp_seo_meta_length('bp_seo_metatitle_length',$meta[0],150);
        		}
        		if($bp_seo_component == $current_component  && !bp_is_single_item())  {
          			$meta = replace_special_tags(get_blog_option(SITE_ID_CURRENT_SITE,"bp_seo_".$current_component.'_profile_extends'));
          			return bp_seo_meta_length('bp_seo_metatitle_length',$meta[0],150);
        		}
      		}
    	}
...
function bp_seo_meta(){
    ...
    <meta name="description" content="<?php echo bp_seo_meta_length('bp_seo_metadesc_length',$meta[1],180) ?>" />
