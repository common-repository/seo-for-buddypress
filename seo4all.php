...
function update_to_seopress(){
	echo '<div class="updated"><p>Seo for Buddypress is no longer supported. Please use <a href="http://wordpress.org/extend/plugins/seopress/">SeoPress</a> from now on.</p></div>'; 
}
add_action('admin_head','update_to_seopress');
